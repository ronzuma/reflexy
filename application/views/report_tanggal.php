						...
						<table class="data-table stripe hover nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<?php echo $trx->jml_cust." Orang" ?>
									</td>
									<td align="right">
										<?php echo nominal($trx->bekam) ?>
									</td>
									<td align="right">
										<?php echo nominal($trx->paket) ?>
									</td>
									<td align="right">
										<?php echo nominal($trx->total) ?>
									</td>
									<td>
										<button type="button" class="btn btn-outline-info" onclick="window.location.href='<?php echo site_url('Report/trx_detail/').date('Y-m-d', strtotime($trx->tgl_trx)); ?>'" >Detail</button>
									</td>
								</tr>
								<?php endforeach; ?>
